	...
	class MFN_Options{
		...
		*/
		function __construct( $menu = array(), $sections = array() ){
			...
			$defaults['opt_name'] = 'cake';
			
			$defaults['menu_icon'] = MFN_OPTIONS_URI.'/img/menu_icon.png';
			$defaults['menu_title'] = __('Cake Theme Options', 'mfn-opts');
			$defaults['page_icon'] = 'icon-themes';
			$defaults['page_title'] = __('Cake Theme Options', 'mfn-opts');
...
//			return (!empty($this->options[$opt_name])) ? $this->options[$opt_name] : $default;
		...
		*/
		function _enqueue(){
			...
			wp_enqueue_style( 'mfn-opts-font', 'http://fonts.googleapis.com/css?family=Open+Sans:400,400italic,600' );
						...
						echo '<div class="mfn-header">';
							echo '<div class="mfn-buttons">';
								...
								echo '<div class="mfn-buttons-more">';
									...
									echo '<a class="mfn-btn-doc" href="http://themes.muffingroup.com/'. $this->args['opt_name'] .'/documentation.pdf" target="_blank"><span>Documentation</span></a>';
