			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<p class="field-css-classes description description-thin">
					<label for="edit-menu-item-classes-<?php echo $item_id; ?>">
						...
						<span class="description"><?php _e('For link with # use <b>scroll</b> class.','mfn-opts'); ?></span>
					</label>
				</p>
				...
				<p class="field-mfn-megamenu description">
                    ...
                    <label for="edit-menu-item-megamenu-<?php echo $item_id; ?>">
                        ...
                        <?php _e( 'Activate Mega Menu','mfn-opts' ); ?><br/>
                        <span class="description"><?php _e( 'This option can be used only for 1st level of Main Menu.', 'mfn-opts' ); ?></span>
                    </label>
				</p>
...
class Walker_Nav_Menu_Mfn extends Walker_Nav_Menu {
	...
	function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		$output .= "\n$indent<ul class=\"sub-menu {tag_ul_class}\">\n";
	}
