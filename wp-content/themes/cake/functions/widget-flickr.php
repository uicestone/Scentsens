...
class Mfn_Flickr_Widget extends WP_Widget {
	...
	function Mfn_Flickr_Widget() {
		...
		$this->WP_Widget( 'widget_mfn_flickr', __( 'Muffin Flickr', 'mfn-opts' ), $widget_ops );
	...
	function widget( $args, $instance ) {
		...
		echo '<div class="Flickr">';
			echo'<script src="http://www.flickr.com/badge_code_v2.gne?count='. $instance['count'] .'&amp;display='. $instance['order'] .'&amp;size=m&amp;layout=x&amp;source=user&amp;user='. $instance['userID'] .'"></script>';
		echo '</div>';
